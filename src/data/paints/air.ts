...
export const airAverlandSunset: PaintDetails = {
...
export const airBalthasarGold: PaintDetails = {
  ...
  hex: '#FFC28A',
  gradient: [
    { offset: 0, color: 'rgb(255, 194, 138)' },
...
export const airIronHandsSteel: PaintDetails = {
  ...
  hex: '#44423F"',
  gradient: [
    { offset: 0, color: 'rgb(239, 237, 233)' },
...
export const airThallaxGold: PaintDetails = {
  ...
  hex: '#722A0B',
  gradient: [
    { offset: 0, color: 'rgb(255, 232, 152)' },
...
export const airPaints = [
  ...
  airTheFang,
  airFlashGitzYellow,
  airTrollSlayerOrange,
  airEvilSunzScarlet,
  airGenestealerPurple,
  airCalgarBlue,
  airLothernBlue,
  airTempleGuardBlue,
  airSybariteGreen,
  ...
  airCalthBlueClear,
  airDeathshroudClear,
  airEidolonPurpleClear,
  airMortarionGreenClear,
  airPhoenicianPurple,
  airPyroclastOrangeClear,
  airSigismundYellowClear,
  airNightLordsBlue,
  airDeathKorpsDrab,
  airVulkanGreen,
  airCorvusBlack,
