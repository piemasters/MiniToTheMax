...
export const baseScreamingBell: PaintDetailsCitadel = {
  ...
  hex: '#642F1F',
  gradient: [
    { offset: 0, color: 'rgb(248, 230, 186)' },
...
export const baseWarplockBronze: PaintDetailsCitadel = {
  ...
  hex: '#440808',
  gradient: [
    { offset: 0, color: 'rgb(242, 194, 168)' },
...
export const baseIronWarriors: PaintDetailsCitadel = {
  ...
  hex: '#D2D2D2',
  gradient: [
    { offset: 0, color: 'rgb(210, 210, 210)' },
...
export const basePaints = [
  ...
  baseTheFang,
  baseScreamerPink,
  baseRetributorArmour,
  baseThousandSonsBlue,
  baseIonrachSkin,
  basePhoenicianPurple,
  baseDeathGuardGreen,
  baseDeathKorpsDrab,
  baseGalVorbakRed,
  baseNightLordsBlue,
