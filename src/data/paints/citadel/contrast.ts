...
export const contrastPaints = [
  ...
  contrastBloodAngelsRed,
  contrastFleshTearersRed,
  contrastVolupusPink,
  contrastShyishPurple,
  contrastMagosPurple,
  contrastLeviadonBlue,
  contrastUltramarineBlue,
  contrastAkhelianGreen,
  contrastDarkAngelsGreen,
  contrastNazdregYellow,
  contrastOrkFlesh,
  contrastCreedCamo,
  contrastMilitarumGreen,
  contrastAggarosDunes,
  contrastSkeletonHorde,
  contrastSnakebiteLeather,
  contrastGoreGruntaFur,
  contrastWyldwood,
  contrastFyreslayerFlesh,
  contrastGuillimanFlesh,
  contrastDarkoathFlesh,
  contrastApothecaryWhite,
  contrastGryphChargerGrey,
  contrastSpaceWolvesGrey,
  contrastBasilicanumGrey,
  contrastBlackTemplar,
  contrastTalassarBlue,
  contrastWarpLightning,
